...
<title>Simpla Admin by www.865171.cn</title>
  <base href="/thinkphp/Application/Admin/View/Public/"/>
  <!--                       CSS                       -->
<!-- Reset Stylesheet -->
...
<div id="body-wrapper">
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
      ...
      <!-- Logo (221px wide) -->
      <a href="http://www.865171.cn"><img id="logo" src="../Public/resources/images/logo.png" alt="Simpla Admin logo" /></a>
  ...
  <div id="main-content">
    ...
    <ul class="shortcut-buttons-set">
      <li><a class="shortcut-button" href="#"><span> <img src="../Public/resources/images/icons/pencil_48.png" alt="icon" /><br />
        Write an Article </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="../Public/resources/images/icons/paper_content_pencil_48.png" alt="icon" /><br />
        Create a New Page </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="../Public/resources/images/icons/image_add_48.png" alt="icon" /><br />
        Upload an Image </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="../Public/resources/images/icons/clock_48.png" alt="icon" /><br />
        Add an Event </span></a></li>
      <li><a class="shortcut-button" href="#messages" rel="modal"><span> <img src="../Public/resources/images/icons/comment_48.png" alt="icon" /><br />
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
              ...
              <a href="#" class="close"><img src="../Public/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" />
              </a>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="#" title="Edit">
                  <img src="../Public/resources/images/icons/pencil.png" alt="Edit" /></a>
                  <a href="#" title="Delete">
                  <img src="../Public/resources/images/icons/cross.png" alt="Delete" /></a>
                  <a href="#" title="Edit Meta">
                  <img src="../Public/resources/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a>
                </td>
              </tr>
              <tr>
                <td>
    ...
    <div class="clear"></div>
    <!-- Start Notifications -->
    <div class="notification attention png_bg"> <a href="#" class="close"><img src="../Public/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
    ...
    <div class="notification information png_bg"> <a href="#" class="close"><img src="../Public/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
    ...
    <div class="notification success png_bg"> <a href="#" class="close"><img src="../Public/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
    ...
    <div class="notification error png_bg"> <a href="#" class="close"><img src="../Public/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
